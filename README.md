...
Rather than subscribe to dozens of newsletters via email, aggregate RSS feeds in one place. Feedly is great for this. It has a web application and smartphone (iOS or Android) app. This makes it efficient to scroll through hundreds of headlines quickly.

Create an account and import the [feedly.opml](https://github.com/Luke-Tech/news_sources/blob/main/feedly.opml) file to loads up everything I have below:
...
Pocket Casts for iOS manages podcasts and can import audiobooks in mp3 format. Install Pocket Casts and import [podcasts.opml](https://github.com/Luke-Tech/news_sources/blob/main/podcasts.opml).
